...
# 服务端启动
java -Xmx4096m -Xms4096m -Dnetease.debug=true -cp netty-all-4.1.32.Final.jar:netty-demo-c1000K-1.0.0.jar com.tony.edu.netty.push.server.WebSocketServer

# 客户端
java -Xmx4096m -Xms4096m -Dnetease.debug=false -Dnetease.pushserver.host=192.168.1.100 -cp netty-all-4.1.32.Final.jar:netty-demo-c1000K-1.0.0.jar com.tony.edu.netty.push.client.WebSocketClient
```
...
linux对外随机分配的端口是有限制,理论上单机对外端口数可达65535,但实际对外可建立的连接默认最大只有28232个[32768   60999]
